...
The database table codes have been attacched to this repository as [data_table_creation.sql](https://github.com/godswill-analytics/Dimensional-Data-Modeling-Project/blob/main/data_table_creation.sql). The database of choice for this project is Microsoft SQL Server
